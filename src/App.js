...
function App() {
  ...
  return (
    ...
    <>
      ...
      <Section h3={map.heading} text={map.text} btnTxt={map.btn} imgSrc={mapImg} backgroundColor={pink} headingColor={yellow} textColor={yellow} hasBtn={false} btnbgColor={brown} btnColor={yellow} /> 

      <Section h3={courses.heading} text={courses.text} btnTxt={courses.btn} imgSrc={coursesImg} imgSize={"30%"} backgroundColor={yellow} headingColor={pink} textColor={pink} btnbgColor={pink} btnColor={yellow} /> 
